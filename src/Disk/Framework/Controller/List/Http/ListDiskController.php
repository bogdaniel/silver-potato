...
namespace App\Disk\Framework\Controller\List\Http;
...
#[Route('/disk/list', name: 'app_disk_list')]
final class ListDiskController extends AbstractController
{
    ...
    public function __invoke(ListDiskRequest $request): Response
    {
        ...
        return $this->registerView->generateView($request, $this->presenter->viewModel());
    }
}
